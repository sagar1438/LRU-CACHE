...
public class Main {
    public static void main(String[] args) {
        ...
        memLRU.put(1, 10, 10);
        memLRU.put(2, 20, 12);
        memLRU.put(3, 30, 12); // exceeds memory (10+12+12=34 > 25), evicts 1
        System.out.println(memLRU.get(1)); // -1
        System.out.println(memLRU.get(2)); // 20
        System.out.println(memLRU.get(3)); // 30

        System.out.println("\n---- ConcurrentLRU ----");
        ConcurrentLRU concLRU = new ConcurrentLRU(2);
        concLRU.put(1, 10);
        concLRU.put(2, 20);
        System.out.println(concLRU.get(1)); // 10
        concLRU.put(3, 30); // evicts 2
        System.out.println(concLRU.get(2)); // -1
        ...
        concMemLRU.put(3, 30, 12); // evicts 1
        System.out.println(concMemLRU.get(1)); // -1
        System.out.println(concMemLRU.get(2)); // 20
        System.out.println(concMemLRU.get(3)); // 30
    }
}
